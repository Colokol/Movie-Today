...
class OnboardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupSlidesScrollView(slides: presenter.sliders)
    }
    ...
    private func currentNextButtonImage() {
        if pageControl.currentPage == presenter.sliders.count - 1 {
            nextButtonFrameImage.image = UIImage(named: "ButtonFrame3")
        } else if pageControl.currentPage == presenter.sliders.count - 2 {
    ...
    private func goToHomeScreen() {
        ...
        let tabBarViewController = Builder.createTabBarViewController()
    ...
    @objc private func nextSlide() {
        ...
        guard nextPageIndex < presenter.sliders.count else {
            goToHomeScreen()
            return
        }
